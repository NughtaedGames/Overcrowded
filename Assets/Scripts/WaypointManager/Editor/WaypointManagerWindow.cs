...
namespace WS20.P3.Overcrowded
{
    public class WaypointManagerWindow : EditorWindow
    {
        ...
        void DrawButtons()
        {
            ...
            {
                if (GUILayout.Button("Add Branch Waypoint")) CreateBranch();

                if (GUILayout.Button("Create Waypoint Before")) CreateWaypointBefore();

                if (GUILayout.Button("Create Waypoint After")) CreateWaypointAfter();
